...
namespace Agenda\ContactoBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Agenda\ContactoBundle\Entity\Contacto;
use Agenda\ContactoBundle\Form\ContactoType;
...
class ContactoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ContactoBundle:Contacto')->findAll();

        return $this->render('ContactoBundle:Contacto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ContactoBundle:Contacto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ContactoBundle:Contacto')->find($id);
        ...
        return $this->render('ContactoBundle:Contacto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ContactoBundle:Contacto:edit.html.twig', array(
            'entity'      => $entity,
